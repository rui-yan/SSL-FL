        ...
        for net_i in range(n_parties):
            if args.model == 'simple-cnn':
                ...
                net = create_model(
                    ...
                    drop_path_rate=args.attn_drop_rate, #0.0
                    drop_block_rate=None,
                    use_mean_pooling=args.use_mean_pooling, #True
                    init_scale=args.init_scale, #0.001
                    use_rel_pos_bias=args.rel_pos_bias, #True
                    use_abs_pos_emb=args.abs_pos_emb, #False
                    init_values=args.layer_scale_init_value,#0.1
                )
            if device == 'cpu':
                net.to(device)
            else:
