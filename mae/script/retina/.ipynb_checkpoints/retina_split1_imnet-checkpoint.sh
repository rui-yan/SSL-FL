...
# ------------------ finetune ----------------- #
CKPT_PATH='/data/yan/SSL-FL/mae_pretrain_ckpt/mae_pretrain_vit_base.pth'
...
CUDA_VISIBLE_DEVICES=0,1,2,4 OMP_NUM_THREADS=1 python -m torch.distributed.launch --nproc_per_node=${N_GPUS} run_class_finetune_FedAvg.py \
     --data_path ${DATA_PATH} \
     --data_set ${DATASET} \
