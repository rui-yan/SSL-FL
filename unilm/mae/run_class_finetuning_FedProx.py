...
def get_args():
    ...
    parser.add_argument("--fed_method", default='FedAvg', type=str, choices=['FedAvg', 'FedProx'] help="federated method")
    parser.add_argument("--mu", default=0.01, choices=[0.001,0.01,0.1,1] # for FedProx
