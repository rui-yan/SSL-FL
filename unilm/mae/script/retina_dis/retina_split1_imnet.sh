...
FT_LR='2e-3'
FT_BATCH_SIZE=64
OUTPUT_PATH_FT="/data/yan/SSL-FL/fedavg_model_ckpt_${N_CLIENTS}/imnet_pretrained_beit_base/finetune_${DATASET}_epoch${FT_EPOCHS}_${SPLIT_TYPE}_lr${FT_LR}_bs${FT_BATCH_SIZE}"
