...
OUTPUT_DIR='/raid/yan/SSL-FL/fedavg_model_ckpt/retina_pretrained_beit_base/pretrained_epoch400_5e-3_central_itercorrected_lr1.5e-4'
...
TOKENIZER_PATH='/home/yan/SSL_FL/tokenizer_weight'
...
# CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=1 python run_beit_pretraining_FedAvg.py \
# --data_path ${DATA_PATH} --data_set CIFAR10 --output_dir ${OUTPUT_DIR} --num_mask_patches 75 \
# --model beit_base_patch16_224_8k_vocab --discrete_vae_weight_path ${TOKENIZER_PATH} \
# --batch_size 32 --lr 1.5e-4 --warmup_epochs 10 --save_ckpt_freq 20 \
# --clip_grad 3.0 --drop_path 0.1 --layer_scale_init_value 0.1 \
