...
OUTPUT_DIR='/data/yan/SSL_FL/fedavg_model_ckpt/random_init_beit_base/covidx_finetune_epoch500_central_3e-3'

# Download and extract CIFAR10
# DATA_PATH='/data/yan/SSL_FL/cifar10'
# DATA_PATH='/data/yan/SSL_FL/Retina'
...
# CKPT_PATH='/data/yan/SSL_FL/fedavg_model_ckpt/imnet_pretrained_beit_base/beit_base_patch16_224_pt22k.pth'

CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=1 python run_class_finetuning_FedAvg.py \
