...
N_CLIENTS=12
MASK_RATIO=0.4 # this is only defined for output path. Need to change num_mask_patches to match this mask ratio. 
N_GPUS=4
...
# CUDA_VISIBLE_DEVICES=3 python run_class_finetuning_FedAvg_distributed.py \
