...
OUTPUT_PATH="/data/yan/SSL-FL/fedavg_model_ckpt/${DATASET}_pretrained_beit_base/pretrained_epoch${EPOCHS}_${SPLIT_TYPE}_lr${LR}_bs${BATCH_SIZE}_dis"
...
# FT_EPOCHS=100
# OUTPUT_PATH_FT="/data/yan/SSL-FL/fedavg_model_ckpt_${N_CLIENTS}/${DATASET}_pretrained_beit_base/pretrained_epoch${EPOCHS}_lr${LR}_bs${BATCH_SIZE}_dis/finetune_${DATASET}_epoch${FT_EPOCHS}_${SPLIT_TYPE}_lr${LR}_bs${BATCH_SIZE}"
