...
LR='2e-3'
BATCH_SIZE=64
OUTPUT_PATH="/data/yan/SSL-FL/fedavg_model_ckpt_${N_CLIENTS}/imnet_pretrained_beit_base/finetune_${DATASET}_epoch${EPOCHS}_${SPLIT_TYPE}_lr${LR}_bs${BATCH_SIZE}"
