...
OUTPUT_DIR='/data/yan/SSL-FL/fedavg_model_ckpt/retina_pretrained_beit_base/finetune_retina_epoch300_spilt_2_lr2e-5'
...
# CKPT_PATH='/data/yan/SSL-FL/fedavg_model_ckpt/cifar10_pretrained_beit_base/pretrained_epoch400_5e-3_spilt_2/checkpoint-379.pth'
CKPT_PATH='/data/yan/SSL-FL/fedavg_model_ckpt/retina_pretrained_beit_base/pretrained_epoch400_5e-3_spilt_2/checkpoint-399.pth'
...
CUDA_VISIBLE_DEVICES=5 OMP_NUM_THREADS=1 python run_class_finetuning_FedAvg.py \
     ...
     --E_epoch 1 --max_communication_rounds 300 --num_local_clients -1 --split_type split_2
