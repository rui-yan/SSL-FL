...
def get_args():
    ...
    parser.add_argument('--data_set', default='IMNET', choices=['CIFAR10', 'ISIC', 'Retina', 'IMNET', 'COVIDfl', 'image_folder', 'PE'],
    ...
    parser.add_argument("--split_type", type=str, choices=["split_1","split_ood", "split_2", "split_3", "split_real", "central"], 
