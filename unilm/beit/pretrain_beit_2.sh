...
OUTPUT_DIR='/data/yan/SSL-FL/fedavg_model_ckpt/retina_pretrained_beit_base/pretrained_epoch400_5e-3_spilt_2'
...
CUDA_VISIBLE_DEVICES=0 OMP_NUM_THREADS=1 python run_beit_pretraining_FedAvg.py \
...
--clip_grad 3.0 --drop_path 0.1 --layer_scale_init_value 0.1 \
--E_epoch 1 --max_communication_rounds 400 --num_local_clients -1 --split_type split_2