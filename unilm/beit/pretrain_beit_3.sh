...
OUTPUT_DIR='/data/yan/SSL_FL/fedavg_model_ckpt/covidx_pretrained_beit_base/pretrained_epoch400_split_3_lr1.5e-3'
# OUTPUT_DIR='/data/yan/SSL-FL/fedavg_model_ckpt/retina_pretrained_beit_base/pretrained_epoch400_5e-3_spilt_3'
...
# --clip_grad 3.0 --drop_path 0.1 --layer_scale_init_value 0.1 \
# --E_epoch 1 --max_communication_rounds 400 --num_local_clients -1 --split_type split_3

# CUDA_VISIBLE_DEVICES=2 OMP_NUM_THREADS=1 python run_beit_pretraining_FedAvg.py \
# --data_path ${DATA_PATH} --data_set CIFAR10 --output_dir ${OUTPUT_DIR} --num_mask_patches 75 \
# --log_dir ${LOG_DIR} \
# --model beit_base_patch16_224_8k_vocab --discrete_vae_weight_path ${TOKENIZER_PATH} \
# --batch_size 32 --lr 5e-3 --warmup_epochs 10 --save_ckpt_freq 20 \
