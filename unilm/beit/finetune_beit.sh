...
# OUTPUT_DIR='/data/yan/SSL-FL/fedavg_model_ckpt/cifar10_pretrained_beit_base/finetune_cifar10_epoch100_spilt_1_new'
OUTPUT_DIR='/data/yan/SSL-FL/fedavg_model_ckpt/retina_pretrained_beit_base/finetune_retina_epoch300_spilt_1_new'
...
CKPT_PATH='/data/yan/SSL-FL/fedavg_model_ckpt/retina_pretrained_beit_base/pretrained_epoch400_5e-3_spilt_1/checkpoint-399.pth'

# '/data/yan/SSL-FL/fedavg_model_ckpt/cifar10_pretrained_beit_base/pretrained_epoch400_5e-3_spilt_1/checkpoint-399.pth'
# CKPT_PATH='/data/yan/SSL-FL/fedavg_model_ckpt/cifar10_pretrained_beit_base/finetune_cifar10_epoch100_spilt_1/checkpoint-499.pth'
...
CUDA_VISIBLE_DEVICES=0 OMP_NUM_THREADS=1 python run_class_finetuning_FedAvg.py \
     ...
     --nb_classes 2 --data_set Retina --disable_eval_during_finetuning \
     --output_dir $OUTPUT_DIR --batch_size 16 --lr 2e-5 --update_freq 1 \
     --warmup_epochs 5 --layer_decay 0.65 --drop_path 0.2 \
     --weight_decay 0.05 --layer_scale_init_value 0.1 --clip_grad 3.0 \
     --E_epoch 1 --max_communication_rounds 300 --num_local_clients -1 --split_type split_1
...
#      --warmup_epochs 5 --layer_decay 0.65 --drop_path 0.2 \
#      --weight_decay 0.05 --layer_scale_init_value 0.1 --clip_grad 3.0 \
#      --E_epoch 1 --max_communication_rounds 100 --num_local_clients -1 --split_type split_1
