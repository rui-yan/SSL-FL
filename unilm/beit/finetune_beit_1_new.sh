...
OUTPUT_DIR='/data/yan/SSL-FL/fedavg_model_ckpt/random_init_beit_base/finetune_cifar10_epoch500_spilt_1'
...
# CKPT_PATH='/data/yan/SSL-FL/fedavg_model_ckpt/cifar10_pretrained_beit_base/pretrained_epoch400_5e-3_spilt_1_v2/checkpoint-399.pth'
...
CUDA_VISIBLE_DEVICES=2 OMP_NUM_THREADS=1 python run_class_finetuning_FedAvg.py \
     ...
     --E_epoch 1 --max_communication_rounds 500 --num_local_clients -1 --split_type split_1
