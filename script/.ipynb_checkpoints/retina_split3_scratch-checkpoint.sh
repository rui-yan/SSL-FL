...
EPOCHS=500
LR='5e-4'
OUTPUT_PATH="/data/yan/SSL-FL/fedavg_model_ckpt/random_init_beit_base/finetune_${DATASET}_epoch${EPOCHS}_${SPLIT_TYPE}_lr${LR}"
...
#      --batch_size 32  --update_freq 1 --split_type ${SPLIT_TYPE} \
...
# ------------------ evaluate ----------------- #
CKPT_PATH="${OUTPUT_PATH}/checkpoint-399.pth"
CUDA_VISIBLE_DEVICES=1 python run_class_finetuning_FedAvg.py \
